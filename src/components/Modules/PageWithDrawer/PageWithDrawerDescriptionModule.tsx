export const PageWithDrawerDescriptionModule = () => {
  return (
    <div className="flex flex-col gap-5">
      <b className="text-lg">Drawer Components</b>
      {/* 
        다양한 상황에서 사용하기 위해 Ant Design의 Drawer 컴포넌트가 아닌 커스텀 모달 컴포넌트를 만들어 사용합니다
        만들어진 컴포넌트를 재사용하거나 보강하여 사용하면 됩니다

        - SnapshotDrawer: Drawer 내부에 들어가는 요소들이 정적이거나 반복되는 경우 사용하는 모달, views/drawer 폴더에 사전 지정하여 사용
        - Drawer: 동적인 상태처리가 필요한 경우 사용하는 컴포넌트, 각 페이지 내부에서 정의하여 사용
